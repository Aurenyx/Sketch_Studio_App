...
class DrawingView(context: Context,attrs:AttributeSet): View(context,attrs) {
    ...
    private val mPaths = ArrayList<CustomPath>() // ArrayList for Paths (Used to save the path and our drawing get visible for some time on screen
...
//        mBrushSize = 20.toFloat()// Paint flag that enables dithering when blitzing.
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        for (p in mPaths) // it lets our stroke visible on the screen
        {
